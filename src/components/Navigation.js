...
import { MdHomeRepairService,MdAnimation,MdContentCopy } from "react-icons/md";
                            ...
                            <NavLink className={'services-dropdown '+v1.navigationList} style={(p1)=>{return {color:p1.isActive?'rgb(226, 30, 81)':undefined}}} to="/services"><span className='navigation-icon'><AiOutlineFolderOpen/></span>Services
                                <div className='services-dropdown-content'>
                                    <div className='services-dropdown-grid'>
                                        <p><MdOutlineDesignServices/> <Link className='drpdown-link' to="/webDesign">Web Design</Link> </p>
                                        <p><BiWorld/> <Link className='drpdown-link' to="/webDevelopment">Web Development</Link></p>
                                        <p><AiOutlineShoppingCart/> <Link className='drpdown-link' to="/eCommerceDev">E-Commerce Development</Link></p>
                                        <p><FaDigitalOcean/> <Link className='drpdown-link' to="/digitalMarketing">Digital Marketing</Link></p>
                                        <p><MdSettingsApplications/> <Link className='drpdown-link' to="/applicationDev">Application Development</Link></p>
                                        <p><TbDeviceMobileMessage/> <Link className='drpdown-link' to="/mobileApplication">Mobile Applications</Link></p>
                                        <p><GrGraphQl/> <Link className='drpdown-link' to="/graphicDesign">Graphic Design</Link></p>
                                        <p><SiDatocms/> <Link className='drpdown-link' to="/cmsDev">CMS Development</Link></p>
                                        <p><MdContentCopy/> <Link className='drpdown-link' to="/arContentDev">3D  Animation, AR VR Content development </Link>  </p>
                                    </div>
                                </div>
                            </NavLink>
